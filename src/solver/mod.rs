#[derive(Clone, Copy)]
pub struct Charge { pub x: f32, pub y: f32, pub q: f32 }
...
impl Solver {
    ...
    pub fn clear(&mut self){ self.charges.clear(); }
    pub fn add(&mut self, x:f32, y:f32, q:f32){ self.charges.push(Charge{x,y,q}); }
